  ...
  return (
    ...
    >
      <StackColumn>
        ...
        />
        <FooterLink 
        text={'info@BlendNet.com'} 
        />
      </StackColumn>
      
      <StackColumn>
        <FooterTitle text={'our services'} />
        <FooterLink text={'buy stock'} />
        <FooterLink text={'sell stock'} />
        <FooterLink text={'stock management'} />
      </StackColumn>
      <StackColumn>
